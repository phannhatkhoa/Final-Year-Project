        ...
        <nav className="flex space-x-4">
          <ul className="flex space-x-4">
            <li>
              <Link
                to="/home"
                className={`text-white hover:text-yellow-300 transition duration-300 font-medium px-3 py-2 rounded-md ${location.pathname === '/home' ? 'text-yellow-300' : ''}`}
              >
                Home
              </Link>
            </li>
            <li>
              <Link
                to="/aboutUs"
                className={`text-white hover:text-yellow-300 transition duration-300 font-medium px-3 py-2 rounded-md ${location.pathname === '/aboutUs' ? 'text-yellow-300' : ''}`}
              >
                About
              </Link>
            </li>
