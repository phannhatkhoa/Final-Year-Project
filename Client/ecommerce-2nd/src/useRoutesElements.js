...
import ManageOrder from "./Pages/Auth/Admin/ManageOrder";
  ...
  const router = createBrowserRouter([
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: `orderHistory/getOrderHistoryByUserId/:user_id`,
          element: (
